...
export default function EditExperience() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await updateExperienceMutation.mutateAsync({ id: id as string, data: submissionData as any });
            router.push('/admin');
        } catch (error) {
    ...
    return (
        <AdminShell activeSection="experiences" tabLabel="edit-experience.tsx" tabIcon={Briefcase}>
            <div className="sticky top-0 z-10 flex items-center gap-3 border-b border-border bg-background/80 px-5 py-3 backdrop-blur">
                ...
                <span className="text-[12px] text-foreground/80">Edit experience</span>
            </div>
