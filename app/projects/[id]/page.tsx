          ...
          <GlassCard className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 bg-gray-600 text-gray-300 px-4 py-2 rounded-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <motion.a
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="flex items-center justify-center gap-3 w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors duration-200 font-medium"
                      >
                      ...
                      {project.githubLink && (
                        <motion.a
                          ...
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="flex items-center justify-center gap-3 w-full bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-lg transition-colors duration-200 font-medium border border-white/20"
                        >
                          <Github className="w-5 h-5" />
                          View Source Code
                        </motion.a>
