...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      animate={{ y: 0 }}
      className={cn(
        "fixed top-3 sm:top-6 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-500",
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="text-white/80 hover:text-white p-2 sm:p-3 rounded-lg sm:rounded-xl transition-all duration-300 hover:bg-white/10"
            >
